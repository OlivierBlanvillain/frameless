...
object FramelessInternals {
  ...
  /** Expression to tag columns from the left hand side of a slef join expression. */
  ...
  /** Expression to tag columns from the right hand side of a slef join expression. */
